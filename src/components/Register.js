...
const Register = () => {
  ...
  const { createUser, updateName, verifyEmail, googleSignUp } = useContext(AuthContext);
      ...
      .then(result => {
        ...
        updateName(name)
          .then(() => {
            ...
            verifyEmail()
            .then(()=> {
              toast.success('Verification Email Sent Please Check Your Email', { autoClose: 500 });
            })
